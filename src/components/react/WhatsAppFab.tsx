    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          whileTap={{ scale: 0.94 }}
          className="group fixed z-[60] right-5 bottom-5 md:right-7 md:bottom-7 w-[56px] h-[56px] md:w-[60px] md:h-[60px] grid place-items-center rounded-full bg-noir text-gold-bright border border-gold/60 shadow-[0_8px_24px_rgba(14,12,8,0.45)] animate-wapulse hover:bg-whatsapp hover:text-white hover:border-whatsapp transition-colors duration-300"
        >
